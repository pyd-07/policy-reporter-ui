...
require (
	...
	github.com/kyverno/policy-reporter-plugins/sdk/api v0.0.0-20260726092009-ebe9e971f90e
...
replace github.com/markbates/goth => github.com/fjogeleit/goth v1.84.0
